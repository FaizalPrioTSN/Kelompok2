                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" id="" class="custom-select select" required>
                                    <option <?php echo $_settings->userdata('gender') == "Male" ? "selected" : '' ?>>Laki-Laki</option>
                                    <option <?php echo $_settings->userdata('gender') == "Female" ? "selected" : '' ?>>Perempuan</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control form" value="" placeholder="(Masukkan Password Baru)">
                            </div>
                            <div class="form-group">
                                <label for="cpassword" class="control-label">Password Sebelumnya</label>
                                <input type="password" name="cpassword" class="form-control form" value="" placeholder="(Masukkan Password Sebelumnya)">
                            </div>
