    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Kosongkan Keranjang</button>
            </div>
        </div>
        <div class="card rounded-0">
            <div class="card-body">
                ...
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                    <div class="col-8 d-flex justify-content-end"><h4>Total Harga:</h4></div>
...
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Apakah Kamu Yakin untuk Mengosongkan Keranjang?",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Apakah Kamu Yakin untuk Menghapus item ini??",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>